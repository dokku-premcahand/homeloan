...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="">Opportunity</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Opportunity Listing</h1>
        </div>
    </div><!--/.row-->
    <div class="col-lg-12">
...
<script type="text/javascript" src="<?php echo base_url('public/js/admin/opportunity/listing.js'); ?>"></script>